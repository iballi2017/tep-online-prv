...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            <div class="pt-3 pb-2 mb-3 border-bottom">
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    ...
                    <div class="font-weight-bold">
                        Status: <span class="display_md_1 uppercase status">pending</span>
                        <!-- 
            ...
            <div class="mb-5">
                <button class="btn btn-success uppercase px-5 rounded-0">Approved</button>
                <button class="btn btn-danger uppercase px-5 rounded-0">Reject</button>
            </div>
