...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" id="modal_show_btn">
                Launch demo modal
            </button>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content py-5">
                        <div class="modal-body">
                            <div class="success_check_wrapper hide">
                            ...
                            <div class="text-center">
                                <h5>Submitted</h5>
                                <p>Kindly wait for the responce</p>
                            </div>
                        </div>
                    </div>
                </div>
